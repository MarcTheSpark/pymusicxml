...
can't explain it line-by-line, it does not belong in this library.

The one exception to the rules above is in scripts for packaging and documentation. These may be written mostly
or entirely with AI assistance, and may receive considerably less scrutiny than the library code. Since they do 
...
human developers tend to cut corners with them despite their usefulness. However, where the library code is 
